  ...
  return (
    <>
      <div className="h-screen w-screen flex justify-center items-center">
        ...
        <div className="border laptop:h-[75%] laptop:w-[40%] tablet:w-[60%] phone:w-[90%] phone:h-fit phone:pb-10 rounded-2xl shadow-xl flex flex-col justify-center items-center gap-10 bg-white">
          <div className="tablet:w-full phone:w-full phone:h-fit tablet:h-full shadow-inner rounded-xl bg-teal-50 p-10">
